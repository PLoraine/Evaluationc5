<?php
$connect = pg_connect("dbname=bdpoireauv2");
?>
>
<!DOCTYPE html>
<html lang="en">
   ...
   <section class="navbar-top container-fluid">
      <div class="row">
         <div class="col-md-12 menu-logo">
            <img class="logo" src="/image/logo.png" alt="Logo de FaisPasLPoireau">
         </div>
      </div>
   </section>
   <!-- Fin menu  -->
               ...
               <div class="container new-sale">
                  ...
                  <form action="">
                     ...
                     <div class="row">
                        ...
                        <?php
                           $resultat= pg_query($connect, "SELECT spro_id FROM stock WHERE sto_pert='true'");
                        >
                        <div class="col-md-9">
                           <div class="form-group">
